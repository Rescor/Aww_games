    ...
    be: {
      translation: {
        hub: {
          ...
          "description": "Тут мы збіраемся разам і гуляем у што-небудзь вясёлае і прыемнае ^__^",
    ...
    ru: {
      translation: {
        hub: {
          ...
          "description": "Здесь мы собираемся вместе и играем во что-нибудь весёлое и приятное ^__^",
    ...
    en: {
      translation: {
        hub: {
          ...
          "description": "Here we get together and play something fun and enjoyable ^__^",
